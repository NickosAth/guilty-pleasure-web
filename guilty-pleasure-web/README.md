...
4. Add the server-only notification variables listed in `.env.example`: `EMAILJS_SERVICE_ID`, `EMAILJS_TEMPLATE_ID`, `EMAILJS_PUBLIC_KEY`, and `FIREBASE_SERVICE_ACCOUNT_BASE64`. Do not add a `VITE_` prefix to these values.
